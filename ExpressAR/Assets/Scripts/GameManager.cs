...
public class GameManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        {
            throw new System.Exception("tcpClient does not exist");
        }
    ...
    public void Update()
    {
        Debug.Log((tcpClient.curFacialExpression != null) + " " + isReadyForGame + " " + !hasFaceBeenSelected);
        if (tcpClient.curFacialExpression != null && isReadyForGame && !hasFaceBeenSelected)
        {
            totalMenu.SetActive(true);
            string expression = ExpressARUtility.getMax(tcpClient.curFacialExpression).Name;
            openAI_TTS._Speak("Face detected!");
